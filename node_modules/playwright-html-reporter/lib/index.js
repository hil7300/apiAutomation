...
class PlaywrightReporter {
    constructor(execOptions) {
        // Const Variables
        this.OUTPUT_FOLDER = "playwright-html-report";
        this.TITLE = "Playwright HTML Report";
        ...
        try {
            ...
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/chartBrowser.html"), "utf-8", (err, data) => {
                if (err)
                    throw err;
            ...
            // Load CSS Files
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/assets/css/style.css"), "utf-8", (err, data) => {
                if (err)
                    throw err;
                this.css = data;
            });
            ...
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/assets/css/prism.css"), "utf-8", (err, data) => {
                if (err)
                    throw err;
                this.prismCss = data;
            });
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/assets/css/img-comparison-slider.css"), "utf-8", (err, data) => {
                if (err)
                    throw err;
                this.imgComparisonSliderCss = data;
            });
            // Load JS Files
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/assets/js/jquery-3.5.1.js"), "utf-8", (err, data) => {
                if (err)
                    throw err;
                this.jQuery = data;
            });
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/assets/js/script.js"), "utf-8", (err, data) => {
                if (err)
                    throw err;
                this.js = data;
            });
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/assets/js/chart.js"), "utf-8", (err, data) => {
                if (err)
                    throw err;
            ...
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/assets/js/dataTables.js"), "utf-8", (err, data) => {
                if (err)
                    throw err;
            ...
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/assets/js/prism.js"), "utf-8", (err, data) => {
                if (err)
                    throw err;
                this.prismJs = data;
            });
            fs_1.default.readFile(path_1.default.resolve(__dirname, "html/assets/js/img-comparison-slider.js"), "utf-8", (err, data) => {
                if (err)
                    throw err;
    ...
    onTestEnd(testCase, result) {
        ...
        switch (result.status.toString()) {
            ...
            case 'timedOut':
                ...
                console.log(`${(0, picocolors_1.bold)((0, picocolors_1.magenta)(`⛔ ${browser}${testCase.title}`))}`);
                break;
            case 'skipped':
            ...
            case 'interrupted':
                ...
                console.log(`${(0, picocolors_1.bold)((0, picocolors_1.gray)(`🚫 ${browser}${testCase.title}`))}`);
                break;
        }
    ...
    async onEnd() {
        ...
        this.execInfo.execBrowsers.forEach((browser, index) => {
            ...
            if (index == 0) {
                ...
                chartRow = chartRow.replace("{{.Percentage}}", ((0, lodash_1.round)((browser.totalTests / this.execInfo.totalTests) * 100, 2)).toString());
        ...
        this.execInfo.execBrowsers.forEach((browser) => {
            ...
            browserSummaryRow = browserSummaryRow.replace("{{.PassedPercentage}}", ((0, lodash_1.round)((browser.totalPassed / browser.totalTests) * 100, 2)).toString());
            browserSummaryRow = browserSummaryRow.replace("{{.FailedValue}}", browser.totalFailed.toString());
            browserSummaryRow = browserSummaryRow.replace("{{.FailedPercentage}}", ((0, lodash_1.round)((browser.totalFailed / browser.totalTests) * 100, 2)).toString());
            browserSummaryRow = browserSummaryRow.replace("{{.TimedOutValue}}", browser.totalTimedOut.toString());
            browserSummaryRow = browserSummaryRow.replace("{{.TimedOutPercentage}}", ((0, lodash_1.round)((browser.totalTimedOut / browser.totalTests) * 100, 2)).toString());
            browserSummaryRow = browserSummaryRow.replace("{{.SkippedValue}}", browser.totalSkipped.toString());
            browserSummaryRow = browserSummaryRow.replace("{{.SkippedPercentage}}", ((0, lodash_1.round)((browser.totalSkipped / browser.totalTests) * 100, 2)).toString());
            browserSummaryRow = browserSummaryRow.replace("{{.InterruptedValue}}", browser.totalInterrupted.toString());
            browserSummaryRow = browserSummaryRow.replace("{{.InterruptedPercentage}}", ((0, lodash_1.round)((browser.totalInterrupted / browser.totalTests) * 100, 2)).toString());
        ...
        if (this.execOptions.startServer === true) {
            ...
            try {
                console.log(`${(0, picocolors_1.bold)((0, picocolors_1.blue)(` `))}`);
                console.log(`${(0, picocolors_1.bold)((0, picocolors_1.blue)(`Serving HTML report at http://localhost:${port}. Press Ctrl+C to quit.`))}`);
                console.log(`${(0, picocolors_1.bold)((0, picocolors_1.blue)(` `))}`);
                const cmd = 'node ' + path_1.default.resolve(__dirname, "") + '/server.mjs ' + port + ' ' + this.execOptions.outputFolder + ' ' + this.INDEX_FILE;
